        ...
        <table class="center">
                ...
                <div class="table-responsive table table-hover table-bordered results">
                    <table class="table table-hover table-bordered">
                        ...
                        <tr>
                            <th id="trs-hd-1" class="col-lg-1">TestDriveID.</th>
                            ...
                            <th id="trs-hd-5" class="col-lg-2">data</th>
            ...
            $records = mysqli_query($con,"select * from test_drive"); // fetch data from database
...
<!--                    <td><a class="fa fa-trash" style="font-size: 15px href="deleteTestDrive.php?id=--><?php //echo $data['id']; ?><!--"></a></td>-->
                     <td><a href="deleteTestDrive.php?id=<?php echo $data['id']; ?>"><button class="btn btn-danger" style="margin-left: 5px;" type="submit"><i class="fa fa-trash" style="font-size: 15px;" </i></button></a></td
                </tr>
                <?php
            }
            ?>
