        ...
        <table class="center">
                ...
                <div class="table-responsive table table-hover table-bordered results">
                    <table class="table table-hover table-bordered">
                        ...
                        <tr>
                            <th id="trs-hd-1" class="col-lg-1">COLORID.</th>
                            <th id="trs-hd-2" class="col-lg-2">Color</th>
            ...
            $records = mysqli_query($con,"SELECT `id`, `color` FROM `color` "); // fetch data from database
